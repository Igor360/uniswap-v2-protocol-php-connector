...
/**
 * @source FurqanSiddiqui\Ethereum\Packages\Keccak
 * This file has been included for SHA3 compatibility, with minor changes/optimizations, from https://github.com/kornrunner/php-keccak
 * LICENSE of original author (Boris Momčilović) is included.
 */
final class Keccak
{
    ...
    private static array $keccakf_rotc = [
        1,
        3,
        6,
        10,
    ...
    private static array $keccakf_piln = [
        10,
        7,
        11,
        17,
